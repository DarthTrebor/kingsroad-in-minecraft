...
public class ExperiencePotion implements KRDPotion
{

    private final KRDPotionType type;
    private final Plugin plugin;

    public ExperiencePotion(KRDPotionType type, Plugin plugin)
    {
        this.type = type;
        this.plugin = plugin;
    }
    ...
    public ItemStack createPotion()
    {
        ...
        if (meta != null) {
            ...
            meta.setLore(List.of(
                    ChatColor.GRAY + "Experience " + ChatColor.BLUE + "(" + durationText + ")",
                    ChatColor.GRAY + "Boosts experience gain by " + ChatColor.BLUE + getBoostPercent() + "%" + ChatColor.GRAY + '.'
            ));

            NamespacedKey potionTypeKey = new NamespacedKey(plugin, "potionType");
            meta.getPersistentDataContainer().set(potionTypeKey, PersistentDataType.STRING, "experience_potion");
    ...
    {
        return type + "_experience_potion";
    }
    ...
    {
        return (type == KRDPotionType.NORMAL ? "" : "Grand ") + "Potion of Experience";
    }
